...
// this once when neither has been registered yet.
...
export const INSTANCES_SYSTEM_PROMPT = `당신은 EN 18031 자가평가의 접근 통제 메커니즘(ACM)과 인증자(Authenticator)를 식별하는 컨설턴트입니다.
...
5. 정보가 부족해도 무선기기·EV 충전기·네트워크 장비 등 통상적 보안 아키텍처를 따라 추론하세요. EN 18031은 "있을 법한 인증 채널"을 모두 평가하는 게 안전합니다.`;
